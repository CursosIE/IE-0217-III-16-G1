...
\subsubsection[{$\sim$\+Cell}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename D$>$ {\bf Cell}$<$ D $>$\+::$\sim${\bf Cell} (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
publico de tipo puntero a D que indica el dato incluido en la celda \hypertarget{class_cell_a7e0e6c090f8aca70862c2dbc3257e3b9}{\index{Cell@{Cell}!next@{next}}
