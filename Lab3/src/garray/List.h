/**
 * @brief Biblioteca que genera un template de una clase abstracta list
...
template <typename D, typename P> /**Biblioteca que genera un template de una clase abstracta list que toma un tipo de dato para los datos contenidos en la lista (D) y otro para los indices de las misma (P)*/
class List {
public:
/**
